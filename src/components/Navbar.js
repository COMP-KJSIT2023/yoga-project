...
export default function Navbar() {
  return (
        <nav>
            <ul>
                <li className="tooltipp-container">
                ...
                <div className="tooltipp">Home</div>
                </li>

                <li className="tooltipp-container">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-clock-history" viewBox="0 0 16 16">
                ...
                <div className="tooltipp">Dashboard</div>
                </li>
                ...
                <div className="tooltipp">Book Appointment</div>
                </li>
                ...
                <div className="tooltipp">About us</div>
                </li>
                ...
                <div className="tooltipp">contact us</div>
                </li>
            </ul>
        </nav>
  )
